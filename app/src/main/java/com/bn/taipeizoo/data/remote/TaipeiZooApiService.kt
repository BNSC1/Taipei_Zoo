...
interface TaipeiZooApiService {
    ...
    suspend fun getTaipeiZooAreas(@Query("scope") scope: String = ApiConst.SCOPE_RESOURCE_ACQUIRE): Response<TaipeiZooAreasResponse>

    @GET("v1/dataset/a3e2b221-75e0-45c1-8f97-75acbd43d613")
    suspend fun getTaipeiZooAnimals(@Query("scope") scope: String = ApiConst.SCOPE_RESOURCE_ACQUIRE): Response<TaipeiZooAnimalsResponse>
}
